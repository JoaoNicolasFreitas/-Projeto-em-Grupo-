...
public class OrganizadorApplication {
    ...
    @Autowired
    public OrganizadorApplication(OrganizadorRepository organizadorRepository) {
    ...
    public Organizador save(Organizador organizador){ return this.organizadorRepository.save(pagamento);}
