...
public class EnderecoController {
    ...
    public ResponseEntity<Endereco> findById(@PathVariable int id) {
        Endereco endereco = enderecoFacade.findById(id);

        if (endereco == null) return new ResponseEntity<Endereco>(endereco, HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<Endereco> save(@RequestBody Endereco endereco) {
        ...
        return new ResponseEntity<>(enderecoSaved, HttpStatus.CREATED);
    }
